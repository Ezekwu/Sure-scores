...
export async function POST(req: NextRequest, res:NextResponse) {    
  ...
  try {
     const response = await sendInvite({sender: '"Workroom" <ezekwujerry@gmail.com>', message: 'Accept the invite to start collaborating', receipient: data.inviteEmail, subject: `${data.senderName} has invited you to work with them in workroom`,})
